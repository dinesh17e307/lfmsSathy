...
class ManagementMessage extends Component{
   getSliderContent = () => {
    ...
    render() {
        return (
          ...
          <Grid item  elevation={6} square style={{minHeight:'400px',margin:'10px auto',borderRadius:'5px',padding:'10px'}}>
                <div >
                   <h1 style={{color:'rgb(149 193 43)',fontSize:'x-large',textTransform:'uppercase'}}>Message <span style={{color:'white' }}>From</span>  Our <span style={{color:'white' }}>management </span> </h1>
